/**
 ******************************************************************************
 * @file       pios_freertos_transition_priv.h
 * @author     Tau Labs, http://taulabs.org, Copyright (C) 2014
 * @brief FreeRTOS to ChibiOS transition header, mapping ISR names.
 *****************************************************************************/
/*
...
#ifndef PIOS_FREERTOS_TRANSITION_PRIV_H_
#define PIOS_FREERTOS_TRANSITION_PRIV_H_
...
#endif /* PIOS_FREERTOS_TRANSITION_PRIV_H_ */
